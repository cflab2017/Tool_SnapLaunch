...
pub struct Strings {
    ...
    pub tip_move_up: &'static str,
    pub tip_move_down: &'static str,
    pub tip_refresh: &'static str,
    pub tip_install: &'static str,
    pub tip_uninstall: &'static str,
    pub tip_browse: &'static str,
    pub tip_add: &'static str,
    pub tip_clear_form: &'static str,
    pub tip_save_edit: &'static str,
    pub tip_cancel_edit: &'static str,
    pub tip_field_name: &'static str,
    pub tip_field_path: &'static str,
    pub tip_field_args: &'static str,
    pub tip_lang_radio: &'static str,
...
pub const LANG_KO: Strings = Strings {
    ...
    tip_move_up: "선택된 툴을 한 칸 위로 이동",
    tip_move_down: "선택된 툴을 한 칸 아래로 이동",
    tip_refresh: "현재 툴 목록을 우클릭 메뉴에 즉시 반영합니다.",
    tip_install: "바탕화면/폴더 빈 공간의 우클릭 메뉴에 \"자주사용하는 툴\" 서브메뉴를 등록합니다.",
    tip_uninstall: "우클릭 메뉴에서 \"자주사용하는 툴\" 항목을 완전히 제거합니다.\n(등록된 툴 목록 파일은 그대로 유지됩니다.)",
    tip_browse: "파일 선택 다이얼로그를 열어 EXE 경로를 채웁니다.",
    tip_add: "위 입력값으로 새 툴을 목록에 추가합니다.",
    tip_clear_form: "이름/경로/인자 입력 필드를 모두 비웁니다.",
    tip_save_edit: "편집한 내용을 저장합니다.",
    tip_cancel_edit: "편집을 취소하고 원래 값으로 되돌립니다.",
    tip_field_name: "우클릭 메뉴에 표시될 이름입니다.",
    tip_field_path: "실행 파일의 전체 경로.\nPATH 에 등록된 명령은 파일명만 적어도 됩니다 (예: calc.exe).",
    tip_field_args: "실행 시 함께 전달할 인자 (공백 구분, 선택 사항).",
    tip_lang_radio: "GUI 와 우클릭 메뉴 항목의 언어를 변경합니다.\n메뉴 텍스트를 갱신하려면 변경 후 \"메뉴 갱신\" 을 누르세요.",
    btn_save: "💾 저장",
    btn_cancel: "취소",
    btn_move_up: "🔼 위로",
    btn_move_down: "🔽 아래로",
...
pub const LANG_EN: Strings = Strings {
    ...
    tip_move_up: "Move the selected tool up one row",
    tip_move_down: "Move the selected tool down one row",
    tip_refresh: "Push the current list to the right-click menu now.",
    tip_install: "Register the \"Favorite Tools\" submenu under the desktop / folder right-click menu.",
    tip_uninstall: "Remove the \"Favorite Tools\" submenu entirely.\n(The tools list file is preserved.)",
    tip_browse: "Open a file picker to fill the path field.",
    tip_add: "Add a new tool to the list using the fields above.",
    tip_clear_form: "Clear the name / path / args fields.",
    tip_save_edit: "Save your edits.",
    tip_cancel_edit: "Discard edits and revert.",
    tip_field_name: "The name shown in the right-click menu.",
    tip_field_path: "Full path to the executable.\nCommands on PATH work too (e.g. calc.exe).",
    tip_field_args: "Arguments passed at launch (space-separated, optional).",
    tip_lang_radio: "Language for the GUI and right-click menu items.\nClick \"Refresh Menu\" after switching to update the menu text.",
    btn_save: "💾 Save",
    btn_cancel: "Cancel",
    btn_move_up: "🔼 Up",
    btn_move_down: "🔽 Down",
